...
def grow_network_gromo(
    ...
    q_head.compute_optimal_updates(maximum_added_neurons=maximum_added_neurons)
    ...
    for global_step in range(args.total_timesteps):
        ...
        if next_growth_idx < len(growth_schedule):
            ...
            if global_step >= grow_at:
                ...
                print(f"global_step={global_step}: grew network to hidden={q_network.encoder.out_features}")
                next_growth_idx += 1
